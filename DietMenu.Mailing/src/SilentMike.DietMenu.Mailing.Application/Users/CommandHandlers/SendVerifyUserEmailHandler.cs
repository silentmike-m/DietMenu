...
internal sealed class SendVerifyUserEmailHandler : IRequestHandler<SendVerifyUserEmail>
{
    ...
    private const string XSLT_HTML_RESOURCE_NAME = "SilentMike.DietMenu.Mailing.Application.Resources.Users.VerifyUserHtmlEmail.xslt";
    private const string XSLT_PLAIN_TEXT_RESOURCE_NAME = "SilentMike.DietMenu.Mailing.Application.Resources.Users.VerifyUserPlainTextEmail.xslt";
    ...
    public SendVerifyUserEmailHandler(
        ILogger<SendVerifyUserEmailHandler> logger,
        IMediator mediator,
    ...
    public async Task<Unit> Handle(SendVerifyUserEmail request, CancellationToken cancellationToken)
    {
        ...
        var email = new Email
        {
            ...
            Subject = "Verify Your DietMenu account",
            TextMessage = text,
        };
