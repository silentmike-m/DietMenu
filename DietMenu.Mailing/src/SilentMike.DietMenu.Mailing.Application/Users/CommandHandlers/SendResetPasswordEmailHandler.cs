...
internal sealed class SendResetPasswordEmailHandler : IRequestHandler<SendResetPasswordEmail>
{
    ...
    private const string XSLT_HTML_RESOURCE_NAME = "SilentMike.DietMenu.Mailing.Application.Resources.Users.ResetPasswordHtmlEmail.xslt";
    private const string XSLT_PLAIN_TEXT_RESOURCE_NAME = "SilentMike.DietMenu.Mailing.Application.Resources.Users.ResetPasswordPlainTextEmail.xslt";
    ...
    public async Task<Unit> Handle(SendResetPasswordEmail request, CancellationToken cancellationToken)
    {
        ...
        var email = new Email
        {
            ...
            Subject = "Reset Your DietMenu account password",
            TextMessage = text,
        };
