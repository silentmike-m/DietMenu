...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://www.w3.org/1999/xhtml">
    <xsl:output method="html" indent="yes" omit-xml-declaration="yes" doctype-public="-//W3C//DTD XHTML 1.1//EN"
                ...
                <div class="container">
                    <div class="content">
                        <div class="content-header">
                            ...
                            <span class="title font-weight-light">DietMenu - family data imported</span>
                        </div>
                            ...
                            <xsl:if test="IsSuccess='false'">
                                ...
                                <ul>
                                    <xsl:if test="ErrorCode">
                                        <li>
                                            <xsl:value-of select="Code" /><xsl:text>: </xsl:text><xsl:value-of
                                                select="Message" />
                                        </li>
                                    </xsl:if>
                                ...
                                <p>Please contact DietMenu support.</p>
                            </xsl:if>
    ...
    <xsl:template match="ImportedFamilyDataError">
        <li>
            <xsl:value-of select="Code" /><xsl:text>: </xsl:text><xsl:value-of select="Message" />
        </li>
    </xsl:template>
</xsl:stylesheet>
