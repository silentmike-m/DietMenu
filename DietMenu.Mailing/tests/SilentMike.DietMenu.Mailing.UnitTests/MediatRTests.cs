...
{
    private const string APPLICATION_ASSEMBLY_NAME = "SilentMike.DietMenu.Mailing.Application";
    private const string INFRASTRUCTURE_ASSEMBLY_NAME = "SilentMike.DietMenu.Mailing.Infrastructure";
