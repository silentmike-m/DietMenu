namespace DietMenu.Api.Infrastructure.HealthChecks;

using System.Text.Json;
using System.Text.Json.Serialization;
using DietMenu.Api.Application.Common;
using DietMenu.Api.Infrastructure.EntityFramework;
using DietMenu.Api.Infrastructure.HealthChecks.Models;
...
internal static class DependencyInjection
{
    ...
    private static async Task HealthCheckResponseWriter(HttpContext context, HealthReport report)
    {
        ...
        var response = new BaseResponse<HealthCheck>
        {
