namespace SilentMike.DietMenu.Core.UnitTests.Domain.Entities;
...
[TestClass]
public sealed class IngredientEntityTests
{
    [TestMethod]
    public void Should_Create_Ingredient()
    {
        ...
        //WHEN
        var result = new IngredientEntity(id, exchanger, familyId, name, type, unitSymbol);
    ...
    public void Should_Set_Exchanger()
    {
        ...
        var ingredient = new IngredientEntity(id, exchanger, familyId, name, type, unitSymbol);
    ...
    public void Should_Throw_Empty_Name_Exception_On_Create_When_Name_Is_Empty_String()
    {
        ...
        //WHEN
        var action = () => new IngredientEntity(id, exchanger, familyId, name, type, unitSymbol);
