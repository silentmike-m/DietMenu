...
public static class ValidationErrorCodes
{
    ...
    public static readonly string UPSERT_INGREDIENT_EMPTY_TYPE = "UPSERT_INGREDIENT_EMPTY_TYPE";
    public static readonly string UPSERT_INGREDIENT_EMPTY_TYPE_MESSAGE = "Ingredient type can not be empty";
