...
{
    public static readonly string ASSIGN_RECIPE_INGREDIENTS_INVALID_QUANTITY = "ASSIGN_RECIPE_INGREDIENTS_INVALID_QUANTITY";
    public static readonly string ASSIGN_RECIPE_INGREDIENTS_INVALID_QUANTITY_MESSAGE = "Recipe ingredient quantity can not be less than 0";
    ...
    public static readonly string UPSERT_INGREDIENTS_INVALID_EXCHANGER_MESSAGE = "Ingredient exchanger can not be less than 0";
