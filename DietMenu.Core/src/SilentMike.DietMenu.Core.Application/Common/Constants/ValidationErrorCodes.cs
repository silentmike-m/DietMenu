...
{
    public static readonly string CONFIRM_EMAIL_EMAIL_FORMAT = "CONFIRM_EMAIL_EMAIL_FORMAT";
    public static readonly string CONFIRM_EMAIL_EMAIL_FORMAT_MESSAGE = "Email must be in correct format";
    public static readonly string CONFIRM_EMAIL_EMPTY_TOKEN = "CONFIRM_EMAIL_EMPTY_TOKEN";
    public static readonly string CONFIRM_EMAIL_EMPTY_TOKEN_MESSAGE = "Token can not be empty";
    ...
    public static readonly string CREATE_EMAIL_CONFIRMATION_TOKEN_INCORRECT_EMAIL_FORMAT = "CREATE_EMAIL_CONFIRMATION_TOKEN_INCORRECT_EMAIL_FORMAT";
    public static readonly string CREATE_EMAIL_CONFIRMATION_TOKEN_INCORRECT_EMAIL_FORMAT_MESSAGE = "Email must be in correct format";
}
